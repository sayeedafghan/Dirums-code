...
const Main = () => {
  ...
  const getRandomColor = () => {
    const colors = ['#fdcb6e', '#e84393', '#54a0ff', '#1dd1a1', '#B53471']; // Lite yellow, lite blue, lite red, lite green, lite navy
      ...
      <div className="header">
        ...
        <nav className="navbar">
          ...
          <div className="profilepic">
            <img
              src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/My-Passport-Size%28Small-Beard%29-1MB.jpg/1200px-My-Passport-Size%28Small-Beard%29-1MB.jpg"
              alt=""
            ></img>
          </div>
      ...
      <main>
        ...
        {editPopup && (
          <div className="taskmodel">
            ...
            />
            <p id="task-status">Edit Task Status*</p>
            ...
            <input
              ...
              onChange={handleRadioChange}
            />
            <p className="due-date">Edit Due date* </p>
            <input
              className="task-date"
              type="date"
              value={dueDate}
            ...
            {editedTaskId !== null && ( // Conditionally render the delete button
